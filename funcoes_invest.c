...
void criarUsuarios(Usuario usuarios[]) {
    ...
    strcpy(usuarios[0].cpf, "12045678904");
    usuarios[0].senha = 444;
    strcpy(usuarios[0].nome, "Livia");
    strcpy(usuarios[0].nome_arquivo, "04_L.bin");

    strcpy(usuarios[1].cpf, "12315678905");
    usuarios[1].senha = 555;
    strcpy(usuarios[1].nome, "Julia");
    strcpy(usuarios[1].nome_arquivo, "05_J.bin");

    strcpy(usuarios[2].cpf, "12342678906");
    usuarios[2].senha = 666;
    strcpy(usuarios[2].nome, "Ana");
    strcpy(usuarios[2].nome_arquivo, "06_A.bin");

    strcpy(usuarios[3].cpf, "12345378907");
    usuarios[3].senha = 777;
    strcpy(usuarios[3].nome, "Ravi");
    strcpy(usuarios[3].nome_arquivo, "07_R.bin");

    strcpy(usuarios[4].cpf, "12345648908");
    usuarios[4].senha = 888;
    strcpy(usuarios[4].nome, "Sergio");
    strcpy(usuarios[4].nome_arquivo, "08_S.bin");

    strcpy(usuarios[5].cpf, "12345675909");
    usuarios[5].senha = 999;
    strcpy(usuarios[5].nome, "Catarina");
    strcpy(usuarios[5].nome_arquivo, "09_C.bin");


    strcpy(usuarios[6].cpf, "12345678610");
    usuarios[6].senha = 000;
    strcpy(usuarios[6].nome, "Mario");
    strcpy(usuarios[6].nome_arquivo, "00_M.bin");
